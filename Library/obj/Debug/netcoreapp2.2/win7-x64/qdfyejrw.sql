...
VALUES ('20200526102315_initial', '2.2.6-servicing-10079');

ALTER TABLE `ServersRelay` ADD `PrivateKey` longtext NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20200527111213_privatekey', '2.2.6-servicing-10079');
